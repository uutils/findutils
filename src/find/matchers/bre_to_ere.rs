...
// TODO: Remove this copied implementation once uutils/coreutils#14531 is
// released in uucore, then use `uucore::regex::bre_to_ere` instead.
...
pub enum RegexError {
    ...
    #[error("range quantifier index is too large")]
